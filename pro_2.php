...
<body>
    ...
    <section class="penyiar-section">
        ...
        <div class="penyiar-container">
            <img class="image-2-icon" src="public/pro2/image 4.png" alt="Background Image">
            <div class="penyiar-item">
                <img src="public/images/rama.png" alt="Lusia Kristina Arebo">
                <p>Rama</p>
            </div>
            <div class="penyiar-item">
                <img src="public/images/dwi.png" alt="Danoe Syah">
                <p>Dwi</p>
            </div>
            <div class="penyiar-item">
                <img src="public/images/tika.png" alt="Revanno Rehatta">
                <p>Tika</p>
            </div>
            <div class="penyiar-item">
                <img src="public/images/eka.png" alt="Prameswara Tyas">
                <p>Eka</p>
            </div>
            <div class="penyiar-item">
                <img src="public/images/tahir.png" alt="Nonnie Dency">
                <p>Tahir</p>
            </div>
        </div>
    </section>
